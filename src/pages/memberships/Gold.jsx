...
import GoldSubscriptionPlans from '../../components/subscriptions/GoldSubscription';
...
const subSections = [
    ...
    {
        title: 'GrapheneOS Support',
        imageUrl: '/assets/images/grapheneos.png',
